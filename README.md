...
Below we simulate a simple dataset, just to show how it works
    ...
    ##         MgSeq Feature (msf) 1.000 0.000 0.000               1.0  0.500
    ##                 RAIDA (rai) 1.000 0.000 0.000               1.0  0.500
    ##            LIMMA voom (vli) 1.000 0.035 0.031               1.0  0.469
    ##               DESeq2 (ds2x) 1.000 0.035 0.062               1.0  0.438
    ##  DESeq2 man. geoMeans (ds2) 1.000 0.035 0.062               1.0  0.438
    ##     EdgeR exact - TMM (ere) 1.000 0.043 0.062               1.0  0.438
    ##    EdgeR exact - RLE (ere2) 1.000 0.049 0.118               1.0  0.382
    ##       EdgeR qll - TMM (erq) 1.000 0.049 0.118               1.0  0.382
    ##                SAMseq (sam) 1.000    NA 0.118               1.0  0.382
    ##      EdgeR qll - RLE (erq2) 1.000 0.054 0.167               1.0  0.333
    ##         ZI-NegBin GLM (znb) 0.500 0.000 0.000               0.0  0.000
    ##        ZI-Poisson GLM (zpo) 0.500 0.000 0.000               0.0  0.000
    ##             MgSeq ZIG (zig) 0.980 0.127 0.434               0.9 -0.002
    ##         ALDEx2 wilcox (adx) 1.000 0.097 0.545               1.0 -0.045
    ##         ALDEx2 t-test (adx) 1.000 0.124 0.583               1.0 -0.083
    ##            Log t-test (ltt) 1.000 0.670 0.901               1.0 -0.401
    ##             Log LIMMA (lli) 1.000 0.689 0.906               1.0 -0.406
    ##     Quasi-Poisson GLM (qpo) 1.000 0.970 0.924               1.0 -0.424
    ##          Log t-test2 (ltt2) 1.000 0.968 0.924               1.0 -0.424
    ##           Poisson GLM (poi) 1.000 1.000 0.925               1.0 -0.425
    ##          Log LIMMA 2 (lli2) 1.000 0.989 0.925               1.0 -0.425
    ##          Negbinom GLM (neb) 1.000 0.989 0.925               1.0 -0.425
    ##                t-test (ttt) 0.986 0.968 0.924               1.0 -0.438
    ##                Wilcox (wil) 0.884 0.957 0.924               1.0 -0.540
    ##           Permutation (per) 0.595 0.962 0.924               1.0 -0.829
    ##  Score.5% Score.95%
    ##     0.500     0.500
    ##     0.077     0.500
    ##     0.035     0.500
