#' Linear regression
#' 
#' Apply linear regression to mulitple features with one \code{predictor}
#' Mixed-effect model is used when a \code{paired} argument is present, with the \code{paired} variable as random intercept
...
#' res <- DA.lrm(data = mat, predictor = pred)
#' @import nlme
#' @export

DA.lrm <- function(data, predictor, paired = NULL, covars = NULL, relative = TRUE, out.all = NULL, p.adj = "fdr", coeff = 2, allResults = FALSE, ...){
